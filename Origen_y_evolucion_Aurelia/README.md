# AureliaLab - Origen y Evolución de Aurelia

## Descripción

## Sitio web interactivo que explora el origen, historia y evolución del framework Aurelia. Presenta información detallada sobre sus versiones, características y comparativas con otros frameworks frontend.

## Características ✨

    Interfaz visual con partículas animadas de Aurelia

    Timeline interactivo de su evolución histórica

    Simulador comparativo de frameworks frontend

    Gráficos dinámicos con Chart.js

    Modales informativos y especificaciones técnicas
...
## Cómo usar 🚀
    ...
    Consulta los detalles en los modales
