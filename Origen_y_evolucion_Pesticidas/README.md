# Pesticidas: Origen y Evolución

## Descripción

## Sitio web interactivo que explora la historia de los pesticidas desde la antigüedad hasta la era moderna, con visualizaciones dinámicas y simulaciones educativas.

## Características ✨

    Línea de tiempo interactiva desde 4500 a.C.

    Simulación de eficacia y resistencia de pesticidas

    Visualización de datos con gráficos animados

    Modo oscuro con temática científica

    Información detallada sobre fabricantes
