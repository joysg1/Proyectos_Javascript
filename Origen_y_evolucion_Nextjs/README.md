# NextLab - Origen y Evolución de Next.js

## Descripción

## Sitio web interactivo que explora el origen, evolución y características del framework Next.js. Presenta información técnica, comparativas con otros frameworks y simulaciones interactivas.

## Características ✨

    Timeline histórico de Next.js desde 2016

    Simulador interactivo de rendimiento

    Comparativa de frameworks React
...
## Cómo usar 🚀
    ...
    Descarga los tres archivos en una carpeta
...
src="https://cdn.jsdelivr.net/npm/simple-icons@v5/icons/tailwindcss.svg" width="24" height="24" /> Tailwind CSS </div> <div style="background: #528DD7; color: white; padding: 15px 25px; border-radius: 10px; font-weight: bold; display: flex; align-items: center; gap: 10px;"> <img src="https://cdn.jsdelivr.net/npm/simple-icons@v5/icons/ionicons.svg" width="24" height="24" /> Ionicons </div> </div>
