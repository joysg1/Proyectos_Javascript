# Print Evolution: Historia de las Impresoras

## Descripción

## Sitio web interactivo sobre la evolución de las impresoras, desde la máquina diferencial de Babbage (1822) hasta la impresión 3D moderna. Presenta una línea de tiempo interactiva, comparativas técnicas y simulaciones de tecnologías de impresión.

## Características ✨

    Línea de tiempo interactiva con hitos históricos

    Simulador comparativo de tecnologías (inyección, láser, matriz, 3D)

    Gráficos dinámicos con Chart.js

    Efectos visuales con partículas CSS

    Modales informativos y comparativas
...
## Cómo usar 🚀
    ...
    Navega por la línea de tiempo histórica

    Usa el simulador para comparar tecnologías

    Explora los gráficos interactivos

    Haz clic en fabricantes para ver detalles
