# Origen y Evolución de las Cremas Estéticas

## Página web interactiva que explora la historia científica de las cremas estéticas desde remedios ancestrales hasta nanotecnología moderna.

## Características ✨

## Timeline histórico interactivo • Simulación de penetración de activos • Visualización de partículas moleculares • Información de laboratorios líderes • Diseño oscuro tecnológico

## Cómo usar 🚀

    Abre cremas_esteticas.html en tu navegador

    Explora las diferentes secciones

    Interactúa con las simulaciones

    Haz clic en los laboratorios para ver detalles
