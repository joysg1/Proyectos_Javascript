...
# Características Principales ✨ 
    ...
    🎨 Visualización interactiva con barras de colores y animaciones suaves

    📊 Estadísticas en tiempo real de comparaciones, intercambios y pasadas

    ⚡ Controles interactivos: inicio, pausa, paso a paso y reinicio

    📱 Diseño responsive que se adapta a diferentes tamaños de pantalla

    🎨 Interfaz moderna con gradientes, efectos visuales y transiciones
