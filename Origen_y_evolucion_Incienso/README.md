...
## Origen y Evolución del Incienso

## Sitio web interactivo que explora la fascinante historia del incienso desde sus orígenes en el antiguo Egipto hasta su renacimiento en la aromaterapia moderna.

## Características ✨

    Timeline histórico interactivo

    Simulador de aromas comparativo
...
## Abre el archivo index.html en cualquier navegador moderno. Explora la evolución histórica, compara diferentes aromas y utiliza el simulador interactivo.
