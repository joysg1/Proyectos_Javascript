# Origen y Evolución de los Aviones

## Historia interactiva de la aviación desde 1903 hasta hoy

## Explora cómo los aviones transformaron el mundo con esta experiencia web interactiva que combina historia, tecnología y simulaciones visuales.

## Características ✨

    Línea de tiempo interactiva de hitos históricos

    Simulación de rendimiento de diferentes aviones

    Galería de fabricantes con detalles técnicos

    Partículas animadas con efectos de vuelo
...
## Cómo usar 🚀
    ...
    Abre aviones.html en tu navegador

    Explora las secciones interactivas

    Usa los controles deslizantes para simular rendimiento

    Haz clic en las tarjetas para ver detalles de fabricantes
